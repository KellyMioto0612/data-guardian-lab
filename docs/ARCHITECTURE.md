...
`DemoProvider` supplies deterministic local data, while `SynapseProvider` reserves the Azure integration seam. This keeps development and tests independent of cloud credentials. Configuration is environment-backed and secrets are never committed.
